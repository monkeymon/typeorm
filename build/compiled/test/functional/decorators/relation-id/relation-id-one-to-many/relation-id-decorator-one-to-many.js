...
describe("decorators > relation-id > one-to-many", function () {
    ...
    it("should load id when RelationId decorator used", function () { return Promise.all(connections.map(function (connection) { return __awaiter(_this, void 0, void 0, function () {
    ...
    it("should load id when RelationId decorator used with additional condition", function () { return Promise.all(connections.map(function (connection) { return __awaiter(_this, void 0, void 0, function () {
        var category, category2, post1, post2, post3, loadedCategories, loadedCategory;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 6:
                    loadedCategories = _a.sent();
                    chai_1.expect(loadedCategories[0].removedPostIds).to.not.be.empty;
