...
describe("decorators > relation-id-decorator > many-to-one", function () {
    ...
    it("should load ids when RelationId decorator used", function () { return Promise.all(connections.map(function (connection) { return __awaiter(_this, void 0, void 0, function () {
