...
describe("entity-metadata > property-map", function () {
    ...
    it("should create correct property map object", function () { return Promise.all(connections.map(function (connection) { return __awaiter(_this, void 0, void 0, function () {
