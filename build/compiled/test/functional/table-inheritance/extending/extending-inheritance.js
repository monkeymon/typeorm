...
describe("table inheritance > regular inheritance using extends keyword", function () {
    ...
    it("should work correctly", function () { return Promise.all(connections.map(function (connection) { return __awaiter(_this, void 0, void 0, function () {
        var post, loadedPost;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 2:
                    ...
                    chai_1.expect(loadedPost.name).not.to.be.empty;
