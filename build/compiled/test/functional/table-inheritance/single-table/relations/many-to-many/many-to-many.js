...
describe("table-inheritance > single-table > relations > many-to-many", function () {
    ...
    describe("owner side", function () {
        it("should work correctly with ManyToMany relations", function () { return Promise.all(connections.map(function (connection) { return __awaiter(_this, void 0, void 0, function () {
