...
describe("entity-model", function () {
    ...
    it("should save successfully and use static methods successfully", function () { return PromiseUtils_1.PromiseUtils.runInSequence(connections, function (connection) { return __awaiter(_this, void 0, void 0, function () {
        var post, loadedPost;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, Post_1.Post.findOne(1)];
                case 2:
                    loadedPost = _a.sent();
    ...
    it("should reload given entity successfully", function () { return PromiseUtils_1.PromiseUtils.runInSequence(connections, function (connection) { return __awaiter(_this, void 0, void 0, function () {
