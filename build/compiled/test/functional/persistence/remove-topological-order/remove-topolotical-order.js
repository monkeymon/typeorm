...
describe("persistence > remove-topological-order", function () {
    ...
    // Specifications
    // -------------------------------------------------------------------------
    it("should remove depend properties in a proper order", function () { return Promise.all(connections.map(function (connection) { return __awaiter(_this, void 0, void 0, function () {
