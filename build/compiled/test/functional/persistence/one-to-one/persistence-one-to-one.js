...
describe("persistence > one-to-one", function () {
    ...
    describe("set the relation with proper item", function () {
        var _this = this;
        it("should have an access token", function () { return Promise.all(connections.map(function (connection) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        chai_1.expect(loadedUser.access_token).not.to.be.empty;
                        return [2 /*return*/];
                }
            });
        }); })); });
    ...
    describe("doesn't allow the same relation to be used twice", function () {
        var _this = this;
        it("should reject the saving attempt", function () { return Promise.all(connections.map(function (connection) { return __awaiter(_this, void 0, void 0, function () {
