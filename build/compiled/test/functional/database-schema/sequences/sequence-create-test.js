...
describe("sequences > creating a sequence and marking the column as generated", function () {
    ...
    describe("create table and check that primary key column is marked as generated", function () {
        var _this = this;
        it("should check that the primary key column is generated automatically", function () { return Promise.all(connections.map(function (connection) { return __awaiter(_this, void 0, void 0, function () {
