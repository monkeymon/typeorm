...
describe("database schema > column length > mssql", function () {
    ...
    it("all relevant types should update their size to max", function () { return Promise.all(connections.map(function (connection) { return __awaiter(_this, void 0, void 0, function () {
        var metadata, queryRunner, table;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
