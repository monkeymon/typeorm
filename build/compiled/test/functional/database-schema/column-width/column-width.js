...
describe("database schema > column width", function () {
    ...
    it("all types should be created with correct width", function () { return Promise.all(connections.map(function (connection) { return __awaiter(_this, void 0, void 0, function () {
    ...
    it("should update data type display width", function () { return Promise.all(connections.map(function (connection) { return __awaiter(_this, void 0, void 0, function () {
