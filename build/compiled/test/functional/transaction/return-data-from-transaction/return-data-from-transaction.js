...
describe("transaction > return data from transaction", function () {
    ...
    it("should allow to return typed data from transaction", function () { return Promise.all(connections.map(function (connection) { return __awaiter(_this, void 0, void 0, function () {
        var _this = this;
        var _a, postId, categoryId, post, category;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, connection.manager.transaction(function (entityManager) { return __awaiter(_this, void 0, void 0, function () {
                        var post, category;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
    ...
    it("should allow to return typed data from transaction using type inference", function () { return Promise.all(connections.map(function (connection) { return __awaiter(_this, void 0, void 0, function () {
        var _this = this;
        var _a, postId, categoryId, post, category;
        return __generator(this, function (_b) {
            switch (_b.label) {
