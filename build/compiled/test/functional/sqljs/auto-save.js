...
describe("sqljs driver > autosave", function () {
    ...
    it("should call autoSaveCallback on insert, update and delete", function () { return Promise.all(connections.map(function (connection) { return __awaiter(_this, void 0, void 0, function () {
...
describe("sqljs driver > autosave off", function () {
    ...
    it("should not call autoSaveCallback when autoSave is disabled", function () { return Promise.all(connections.map(function (connection) { return __awaiter(_this, void 0, void 0, function () {
