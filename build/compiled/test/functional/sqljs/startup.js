...
describe("sqljs driver > startup", function () {
    ...
    it("should startup even if the file doesn't exist", function () { return Promise.all(connections.map(function (connection) { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
    ...
    it("should write a new file after first write operation", function () { return Promise.all(connections.map(function (connection) { return __awaiter(_this, void 0, void 0, function () {
        var post, repository;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
