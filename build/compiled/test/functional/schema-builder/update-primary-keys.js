...
describe("schema builder > update primary keys", function () {
    ...
    it("should correctly update composite primary keys", function () { return Promise.all(connections.map(function (connection) { return __awaiter(_this, void 0, void 0, function () {
    ...
    it("should correctly update composite primary keys when table already have primary generated column", function () { return Promise.all(connections.map(function (connection) { return __awaiter(_this, void 0, void 0, function () {
        var metadata, nameColumn, queryRunner, table;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
