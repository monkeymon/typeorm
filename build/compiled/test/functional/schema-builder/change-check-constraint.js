...
describe("schema builder > change check constraint", function () {
    ...
    it("should correctly add new check constraint", function () { return src_1.PromiseUtils.runInSequence(connections, function (connection) { return __awaiter(_this, void 0, void 0, function () {
    ...
    it("should correctly change check", function () { return src_1.PromiseUtils.runInSequence(connections, function (connection) { return __awaiter(_this, void 0, void 0, function () {
    ...
    it("should correctly drop removed check", function () { return src_1.PromiseUtils.runInSequence(connections, function (connection) { return __awaiter(_this, void 0, void 0, function () {
        var postMetadata, queryRunner, table;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
