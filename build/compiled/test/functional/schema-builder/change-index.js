...
describe("schema builder > change index", function () {
    ...
    it("should correctly add new index", function () { return src_1.PromiseUtils.runInSequence(connections, function (connection) { return __awaiter(_this, void 0, void 0, function () {
    ...
    it("should correctly change index", function () { return src_1.PromiseUtils.runInSequence(connections, function (connection) { return __awaiter(_this, void 0, void 0, function () {
    ...
    it("should correctly drop removed index", function () { return src_1.PromiseUtils.runInSequence(connections, function (connection) { return __awaiter(_this, void 0, void 0, function () {
        var studentMetadata, queryRunner, studentTable;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    it("should ignore index synchronization when `synchronize` set to false", function () { return src_1.PromiseUtils.runInSequence(connections, function (connection) { return __awaiter(_this, void 0, void 0, function () {
