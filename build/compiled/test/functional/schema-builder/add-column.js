...
describe("schema builder > add column", function () {
    ...
    it("should correctly add column", function () { return Promise.all(connections.map(function (connection) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    (_a = postMetadata.columns).push.apply(_a, [columnMetadata1, columnMetadata2]);
