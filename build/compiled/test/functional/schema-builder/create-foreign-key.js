...
describe("schema builder > create foreign key", function () {
    ...
    it("should correctly create foreign key", function () { return Promise.all(connections.map(function (connection) { return __awaiter(_this, void 0, void 0, function () {
        var categoryMetadata, postMetadata, columns, referencedColumns, fkMetadata, queryRunner, table;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
