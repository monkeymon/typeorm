...
describe("schema builder > create table", function () {
    ...
    it("should correctly create tables with all dependencies", function () { return Promise.all(connections.map(function (connection) { return __awaiter(_this, void 0, void 0, function () {
