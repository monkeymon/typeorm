...
describe("entity-schema > uniques", function () {
    ...
    it("should create an unique constraint with 2 columns", function () { return Promise.all(connections.map(function (connection) { return __awaiter(_this, void 0, void 0, function () {
            ...
            switch (_a.label) {
                ...
                case 2:
                    ...
                    if (connection.driver instanceof MysqlDriver_1.MysqlDriver) {
                        ...
                        chai_1.expect(table.uniques[0].columnNames).to.include.members(["FirstName", "LastName"]);
                    }
                    else {
                        chai_1.expect(table.uniques.length).to.be.equal(1);
