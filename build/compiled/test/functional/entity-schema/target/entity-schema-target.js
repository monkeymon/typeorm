...
describe("entity schemas > target option", function () {
    ...
    it("should create instance of the target", function () { return Promise.all(connections.map(function (connection) { return __awaiter(_this, void 0, void 0, function () {
    ...
    it("should find instances of the target", function () { return Promise.all(connections.map(function (connection) { return __awaiter(_this, void 0, void 0, function () {
