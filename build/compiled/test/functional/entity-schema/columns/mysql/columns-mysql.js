...
describe("entity-schema > columns > mysql", function () {
    ...
    it("should create columns with different options", function () { return Promise.all(connections.map(function (connection) { return __awaiter(_this, void 0, void 0, function () {
