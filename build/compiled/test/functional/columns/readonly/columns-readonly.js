...
describe("columns > readonly functionality", function () {
    ...
    it("should not update columns marked with readonly property", function () { return Promise.all(connections.map(function (connection) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    ...
                    chai_1.expect(loadedPost.authorName).to.be.equal("Umed1");
                    return [2 /*return*/];
            }
        });
    }); })); });
