...
describe("columns > value-transformer functionality", function () {
    ...
    it("should marshal data using the provided value-transformer", function () { return Promise.all(connections.map(function (connection) { return __awaiter(_this, void 0, void 0, function () {
