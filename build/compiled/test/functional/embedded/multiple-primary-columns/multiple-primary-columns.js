...
describe("embedded > multiple-primary-column", function () {
    ...
    it("should insert, load, update and remove entities with embeddeds when primary column defined in main and in embedded entities", function () { return Promise.all(connections.map(function (connection) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    ...
                    return [4 /*yield*/, postRepository.findOneById({ id: 1, counters: { code: 1 } })];
                case 4:
                    loadedPost = (_a.sent());
