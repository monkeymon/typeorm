...
describe("query builder > enabling transaction", function () {
    ...
    it("should execute query in a transaction", function () { return Promise.all(connections.map(function (connection) { return __awaiter(_this, void 0, void 0, function () {
        var post;
