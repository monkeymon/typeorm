...
describe("query builder > relation-id > one-to-many > basic-functionality", function () {
    ...
    it("should load id when loadRelationIdAndMap used with OneToMany relation", function () { return Promise.all(connections.map(function (connection) { return __awaiter(_this, void 0, void 0, function () {
    ...
    it("should load id when loadRelationIdAndMap used with additional condition", function () { return Promise.all(connections.map(function (connection) { return __awaiter(_this, void 0, void 0, function () {
        var category1, category2, category3, category4, post1, post2, loadedPosts, loadedPost;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    it("should load id when loadRelationIdAndMap used on nested relation", function () { return Promise.all(connections.map(function (connection) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 12:
                    ...
                    chai_1.expect(loadedPosts[0].categories[1].imageIds).to.not.be.empty;
                    ...
                    chai_1.expect(loadedPosts[1].categories[1].imageIds).to.be.empty;
                    return [4 /*yield*/, connection.manager
                            .createQueryBuilder(Post_1.Post, "post")
                            .loadRelationIdAndMap("post.categoryIds", "post.categories")
                            .leftJoinAndSelect("post.categories", "category")
                ...
                case 13:
                    ...
                    chai_1.expect(loadedPost.categories[1].imageIds).to.not.be.empty;
