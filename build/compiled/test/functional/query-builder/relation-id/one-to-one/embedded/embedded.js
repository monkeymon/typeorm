...
describe("query builder > relation-id > one-to-one > embedded", function () {
    ...
    it("should load ids when loadRelationIdAndMap used on embedded and nested embedded tables", function () { return Promise.all(connections.map(function (connection) { return __awaiter(_this, void 0, void 0, function () {
