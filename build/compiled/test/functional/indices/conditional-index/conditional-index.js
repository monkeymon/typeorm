...
describe("indices > conditional index", function () {
    ...
    it("should correctly create conditional indices with WHERE condition", function () { return Promise.all(connections.map(function (connection) { return __awaiter(_this, void 0, void 0, function () {
    ...
    it("should correctly drop conditional indices and revert drop", function () { return Promise.all(connections.map(function (connection) { return __awaiter(_this, void 0, void 0, function () {
        var queryRunner, table;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
