...
describe("uuid-mysql", function () {
    ...
    it("should set generated uuid in the model after save", function () { return Promise.all(connections.map(function (connection) { return __awaiter(_this, void 0, void 0, function () {
        var question;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
