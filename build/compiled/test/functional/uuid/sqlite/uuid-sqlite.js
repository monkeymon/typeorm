...
describe("uuid-sqlite", function () {
    ...
    it("should persist uuid correctly when it is generated non primary column", function () { return Promise.all(connections.map(function (connection) { return __awaiter(_this, void 0, void 0, function () {
        var postRepository, questionRepository, queryRunner, postTableSchema, questionTableSchema, post, loadedPost, post2, loadedPost2, question, savedQuestion, loadedQuestion, question2, loadedQuestion2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 8:
                    ...
                    return [4 /*yield*/, questionRepository.findOneById(savedQuestion.id)];
                case 9:
                ...
                case 10:
                    _a.sent();
                    return [4 /*yield*/, questionRepository.findOneById("1ecad7f6-23ee-453e-bb44-16eca26d5189")];
                case 11:
