...
describe("mongodb > embedded columns", function () {
    ...
    it("should store results in correct camelCase format", function () { return Promise.all(connections.map(function (connection) { return __awaiter(_this, void 0, void 0, function () {
