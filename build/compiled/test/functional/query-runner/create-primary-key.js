...
describe("query runner > create primary key", function () {
    ...
    it("should correctly create primary key and revert creation", function () { return Promise.all(connections.map(function (connection) { return __awaiter(_this, void 0, void 0, function () {
