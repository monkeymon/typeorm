...
describe("query runner > create index", function () {
    ...
    it("should correctly create index and revert creation", function () { return Promise.all(connections.map(function (connection) { return __awaiter(_this, void 0, void 0, function () {
        var queryRunner, index, table;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
