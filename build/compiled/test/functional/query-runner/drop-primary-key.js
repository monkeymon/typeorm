...
describe("query runner > drop primary key", function () {
    ...
    it("should correctly drop primary key and revert drop", function () { return Promise.all(connections.map(function (connection) { return __awaiter(_this, void 0, void 0, function () {
