...
describe("query runner > drop table", function () {
    ...
    it("should correctly drop table without relations and revert drop", function () { return Promise.all(connections.map(function (connection) { return __awaiter(_this, void 0, void 0, function () {
    ...
    it("should correctly drop table with relations and revert drop", function () { return Promise.all(connections.map(function (connection) { return __awaiter(_this, void 0, void 0, function () {
