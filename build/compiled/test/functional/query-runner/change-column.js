...
describe("query runner > change column", function () {
    ...
    it("should correctly change column and revert change", function () { return Promise.all(connections.map(function (connection) { return __awaiter(_this, void 0, void 0, function () {
    ...
    it("should correctly change column 'isGenerated' property and revert change", function () { return Promise.all(connections.map(function (connection) { return __awaiter(_this, void 0, void 0, function () {
