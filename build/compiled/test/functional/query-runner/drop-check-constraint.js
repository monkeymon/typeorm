...
describe("query runner > drop check constraint", function () {
    ...
    it("should correctly drop check constraint and revert drop", function () { return Promise.all(connections.map(function (connection) { return __awaiter(_this, void 0, void 0, function () {
