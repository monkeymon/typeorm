...
describe("query runner > drop unique constraint", function () {
    ...
    it("should correctly drop unique constraint and revert drop", function () { return Promise.all(connections.map(function (connection) { return __awaiter(_this, void 0, void 0, function () {
