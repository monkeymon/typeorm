...
describe("query runner > add column", function () {
    ...
    it("should correctly add column and revert add", function () { return Promise.all(connections.map(function (connection) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    if (!(connection.driver instanceof MysqlDriver_1.MysqlDriver) && !(connection.driver instanceof AbstractSqliteDriver_1.AbstractSqliteDriver)) {
