...
describe("query runner > create unique constraint", function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, test_utils_1.createTestingConnections({
                        ...
                        enabledDrivers: ["mssql", "postgres", "sqlite", "oracle"],
                        schemaCreate: true,
                        dropSchema: true,
                    })];
                case 1:
    ...
    it("should correctly create unique constraint and revert creation", function () { return Promise.all(connections.map(function (connection) { return __awaiter(_this, void 0, void 0, function () {
