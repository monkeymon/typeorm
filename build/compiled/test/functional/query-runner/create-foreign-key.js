...
describe("query runner > create foreign key", function () {
    ...
    it("should correctly create foreign key and revert creation", function () { return Promise.all(connections.map(function (connection) { return __awaiter(_this, void 0, void 0, function () {
