...
describe("tree tables > closure-table", function () {
    ...
    it("categories should be attached via parent and saved properly", function () { return Promise.all(connections.map(function (connection) { return __awaiter(_this, void 0, void 0, function () {
    ...
    it.skip("categories should remove removed children", function () { return Promise.all(connections.map(function (connection) { return __awaiter(_this, void 0, void 0, function () {
    ...
    // todo: finish implementation and implement on other trees
    it.skip("sub-category should be removed with all its children", function () { return Promise.all(connections.map(function (connection) { return __awaiter(_this, void 0, void 0, function () {
        var categoryRepository, a1, a11, a12, a1Children1, a1ChildrenNames1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
