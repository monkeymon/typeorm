...
describe.skip("benchmark > bulk-save", function () {
    var connections;
    ...
    it("testing bulk save of 1000 objects", function () { return Promise.all(connections.map(function (connection) { return __awaiter(_this, void 0, void 0, function () {
        var posts, i, post;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
...
//# sourceMappingURL=bulk-save.js.map