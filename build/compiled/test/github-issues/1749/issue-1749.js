...
describe("github issues > #1749 Can't delete tables in non-default schema", function () {
    ...
    it("should delete entites from tables in different schemas", function () { return Promise.all(connections.map(function (connection) { return __awaiter(_this, void 0, void 0, function () {
