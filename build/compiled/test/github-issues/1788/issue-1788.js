...
describe("github issues > #1788 One to One does not load relationships.", function () {
    ...
    it("should work as expected when using find* methods with relations explicitly provided", function () { return Promise.all(connections.map(function (connection) { return __awaiter(_this, void 0, void 0, function () {
