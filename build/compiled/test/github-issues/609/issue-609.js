...
describe("github issues > #609 Custom precision on CreateDateColumn and UpdateDateColumn", function () {
    ...
    it("should create `CreateDateColumn` and `UpdateDateColumn` column with custom default", function () { return Promise.all(connections.map(function (connection) { return __awaiter(_this, void 0, void 0, function () {
