...
describe("github issues > #438 how can i define unsigned column?", function () {
    ...
    it("should correctly create and change column with UNSIGNED and ZEROFILL attributes", function () { return Promise.all(connections.map(function (connection) { return __awaiter(_this, void 0, void 0, function () {
