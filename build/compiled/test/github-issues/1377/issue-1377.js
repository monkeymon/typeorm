...
describe("github issues > #1377 Add support for `GENERATED ALWAYS AS` in MySQL", function () {
    ...
    it("should correctly create table with generated columns", function () { return Promise.all(connections.map(function (connection) { return __awaiter(_this, void 0, void 0, function () {
