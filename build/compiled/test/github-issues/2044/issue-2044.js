...
describe("github issues > #2044 Should not double get embedded column value", function () {
    ...
    it("Insert query should work with relational columns", function () { return Promise.all(connections.map(function (connection) { return __awaiter(_this, void 0, void 0, function () {
