...
describe("github issues > #807 Error in persisting dates", function () {
    ...
    it("should be able to save dates as objects", function () { return Promise.all(connections.map(function (connection) { return __awaiter(_this, void 0, void 0, function () {
        var tournament;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    it("should be able to save dates as strings", function () { return Promise.all(connections.map(function (connection) { return __awaiter(_this, void 0, void 0, function () {
        var tournament;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
