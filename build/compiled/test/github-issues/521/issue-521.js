...
describe("github issues > #521 Attributes in UPDATE in QB arent getting replaced", function () {
    ...
    it("should replace parameters", function () { return Promise.all(connections.map(function (connection) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            ...
            _a = qb
                ...
                .getQueryAndParameters(), query = _a[0], parameters = _a[1];
