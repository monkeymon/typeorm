...
describe("github issues > #1615 Datetime2 with any precision result in datetime2(7) in database", function () {
    ...
    it("should correctly create column with Datetime2 type and any precision", function () { return Promise.all(connections.map(function (connection) { return __awaiter(_this, void 0, void 0, function () {
