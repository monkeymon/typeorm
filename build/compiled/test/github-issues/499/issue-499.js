...
describe("github issues > #499 postgres DATE hydrated as DATETIME object", function () {
    ...
    it("should return date in a string format", function () { return Promise.all(connections.map(function (connection) { return __awaiter(_this, void 0, void 0, function () {
        var post, loadedPost;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
