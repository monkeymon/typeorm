...
describe("github issues > #320 Bug in getManyAndCount", function () {
    ...
    it("should correctly parse type from PrimaryGeneratedColumn options", function () { return Promise.all(connections.map(function (connection) { return __awaiter(_this, void 0, void 0, function () {
        var tiles, query;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
