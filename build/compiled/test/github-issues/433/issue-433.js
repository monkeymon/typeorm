...
describe("github issues > #433 default value (json) is not getting set in postgreSQL", function () {
    ...
    it("should successfully set default value in to JSON type column", function () { return Promise.all(connections.map(function (connection) { return __awaiter(_this, void 0, void 0, function () {
        var post, loadedPost;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
