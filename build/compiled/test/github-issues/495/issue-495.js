...
describe("github issues > #495 Unable to set multi-column indices", function () {
    ...
    it("should successfully create indices and save an object", function () { return Promise.all(connections.map(function (connection) { return __awaiter(_this, void 0, void 0, function () {
        var user, item;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
