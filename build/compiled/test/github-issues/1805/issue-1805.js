...
describe("github issues > #1805 bigint PK incorrectly returning as a number (expecting a string)", function () {
    ...
    it("should return `bigint` column as string", function () { return src_1.PromiseUtils.runInSequence(connections, function (connection) { return __awaiter(_this, void 0, void 0, function () {
