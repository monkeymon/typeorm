...
describe("github issue > #1397 Spaces at the end of values are removed when inserting", function () {
    ...
    it("should not trim empty spaces when saving", function () { return Promise.all(connections.map(function (connection) { return __awaiter(_this, void 0, void 0, function () {
        var post, loadedPost;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
