...
describe("github issues > #953 MySQL 5.7 JSON column parse", function () {
    ...
    it("should retrieve record from mysql5.7 using driver mysql2", function () { return Promise.all(connections.map(function (connection) { return __awaiter(_this, void 0, void 0, function () {
        var repo, user, user1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
