...
describe("indices > create schema", function () {
    ...
    describe("build schema", function () {
        var _this = this;
        it("it should just work, creating the index", function () { return Promise.all(connections.map(function (connection) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
