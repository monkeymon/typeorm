...
describe("github issues > #493 pagination should work with string primary keys", function () {
    ...
    it("should work perfectly with string primary keys", function () { return Promise.all(connections.map(function (connection) { return __awaiter(_this, void 0, void 0, function () {
