...
describe.skip("github issues > #1591 Define order of relation data when querying on the main entity", function () {
    ...
    it("should query correct number of users with joined data ordering applied", function () { return Promise.all(connections.map(function (connection) { return __awaiter(_this, void 0, void 0, function () {
        var i, photo1, photo2, user, users;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    i = 0;
