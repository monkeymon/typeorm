...
describe("github issues > #1981 Boolean values not casted properly when used in .find() condition", function () {
    ...
    it("should be able to find by boolean find", function () { return Promise.all(connections.map(function (connection) { return __awaiter(_this, void 0, void 0, function () {
