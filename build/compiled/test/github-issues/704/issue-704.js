...
describe("github issues > #704 Table alias in WHERE clause is not quoted in PostgreSQL", function () {
    ...
    it("should return user by a given email and proper escape 'user' keyword", function () { return Promise.all(connections.map(function (connection) { return __awaiter(_this, void 0, void 0, function () {
        var user, loadedUser;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
