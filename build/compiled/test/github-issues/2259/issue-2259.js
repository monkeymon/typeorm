...
describe("github issues > #2259 Missing type for generated columns", function () {
    ...
    it("Should create table with generated column", function () { return Promise.all(connections.map(function (connection) { return __awaiter(_this, void 0, void 0, function () {
        var id, client;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
