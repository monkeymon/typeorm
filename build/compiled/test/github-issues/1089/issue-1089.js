...
describe("github issues > #1089 UUID in ClosureEntity", function () {
    ...
    it("should correctly work with primary UUID column", function () { return Promise.all(connections.map(function (connection) { return __awaiter(_this, void 0, void 0, function () {
