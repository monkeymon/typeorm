...
describe("github issues > #1140 timestamp column and value transformer causes TypeError", function () {
    ...
    it("correctly store/load timestamp columns", function () { return Promise.all(connections.map(function (connection) { return __awaiter(_this, void 0, void 0, function () {
