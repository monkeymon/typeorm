...
describe("github issues > #594 WhereInIds no longer works in the latest version.", function () {
    ...
    it("should load entities by given simple post ids (non mixed)", function () { return Promise.all(connections.map(function (connection) { return __awaiter(_this, void 0, void 0, function () {
