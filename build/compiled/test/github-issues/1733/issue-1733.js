...
describe("github issues > #1733 Postgresql driver does not detect/support varying without length specified", function () {
    ...
    it("should correctly synchronize schema when varchar column length is not specified", function () { return Promise.all(connections.map(function (connection) { return __awaiter(_this, void 0, void 0, function () {
