...
describe("save child and parent entity", function () {
    ...
    it("account property in accountActivationToken should not be null", function () { return Promise.all(connections.map(function (connection) { return __awaiter(_this, void 0, void 0, function () {
