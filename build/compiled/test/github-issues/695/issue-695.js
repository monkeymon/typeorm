...
describe("github issues > #695 Join columns are not using correct length", function () {
    ...
    it("should set correct length on to join columns", function () { return Promise.all(connections.map(function (connection) { return __awaiter(_this, void 0, void 0, function () {
