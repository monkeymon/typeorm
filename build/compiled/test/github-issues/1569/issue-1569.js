...
describe("github issue > #1569 updateById generates wrong SQL with arrays inside embeddeds", function () {
    ...
    it("should properly updateById arrays inside embeddeds", function () { return Promise.all(connections.map(function (connection) { return __awaiter(_this, void 0, void 0, function () {
