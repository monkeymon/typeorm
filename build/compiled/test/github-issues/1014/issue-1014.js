...
describe("github issues > #1014 Transaction doesn't rollback", function () {
    ...
    it("should rollback transaction if some operation failed in it", function () { return Promise.all(connections.map(function (connection) { return __awaiter(_this, void 0, void 0, function () {
